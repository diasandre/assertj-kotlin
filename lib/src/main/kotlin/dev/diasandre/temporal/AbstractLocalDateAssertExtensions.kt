...
infix fun AbstractLocalDateAssert<*>.isBeforeOrEqualTo(localDateAsString: String): AbstractLocalDateAssert<*> = isBefore(localDateAsString)
infix fun AbstractLocalDateAssert<*>.isAfterOrEqualTo(other: LocalDate): AbstractLocalDateAssert<*> = isBeforeOrEqualTo(other)
infix fun AbstractLocalDateAssert<*>.isAfterOrEqualTo(localDateAsString: String): AbstractLocalDateAssert<*> = isBefore(localDateAsString)
infix fun AbstractLocalDateAssert<*>.isAfter(other: LocalDate): AbstractLocalDateAssert<*> = isBeforeOrEqualTo(other)
infix fun AbstractLocalDateAssert<*>.isAfter(localDateAsString: String): AbstractLocalDateAssert<*> = isBefore(localDateAsString)
