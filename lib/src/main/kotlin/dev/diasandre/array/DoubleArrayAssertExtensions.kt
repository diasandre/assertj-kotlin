...
infix fun DoubleArrayAssert.hasSizeGreaterThanOrEqualTo(expected: Int): DoubleArrayAssert = hasSizeGreaterThanOrEqualTo(expected)
infix fun DoubleArrayAssert.hasSizeLessThan(expected: Int): DoubleArrayAssert = hasSizeLessThan(expected)
infix fun DoubleArrayAssert.hasSizeLessThanOrEqualTo(expected: Int): DoubleArrayAssert = hasSizeLessThanOrEqualTo(expected)
infix fun DoubleArrayAssert.hasSameSizeAs(expected: Iterable<*>): DoubleArrayAssert = hasSameSizeAs(expected)
...
infix fun DoubleArrayAssert.containsSubsequence(values: Array<Double>): DoubleArrayAssert = containsSubsequence(values)
infix fun DoubleArrayAssert.doesNotContain(values: Array<Double>): DoubleArrayAssert = doesNotContain(values)
...
infix fun DoubleArrayAssert.isSortedAccordingTo(comparator: Comparator<Double>): DoubleArrayAssert = isSortedAccordingTo(comparator)
infix fun DoubleArrayAssert.containsExactly(values: Array<Double>): DoubleArrayAssert = containsExactly(values)
infix fun DoubleArrayAssert.containsExactlyInAnyOrder(values: Array<Double>): DoubleArrayAssert = containsExactlyInAnyOrder(values)
infix fun DoubleArrayAssert.containsAnyOf(values: Array<Double>): DoubleArrayAssert = containsAnyOf(values)

infix fun DoubleArrayAssert.hasSizeBetween(block: () -> Pair<Int, Int>): DoubleArrayAssert {
    val (start, end) = block()
    return hasSizeBetween(start, end)
}

infix fun DoubleArrayAssert.contains(block: () -> Pair<Double, Index>): DoubleArrayAssert {
    val (value, index) = block()
    return contains(value, index)
}

infix fun DoubleArrayAssert.doesNotContain(block: () -> Pair<Double, Index>): DoubleArrayAssert {
    val (value, index) = block()
