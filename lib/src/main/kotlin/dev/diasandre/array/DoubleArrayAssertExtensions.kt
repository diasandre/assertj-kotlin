...
infix fun DoubleArrayAssert.contains(pair: Pair<Double, Int>): DoubleArrayAssert =
...
infix fun DoubleArrayAssert.doesNotContain(pair: Pair<Double, Int>): DoubleArrayAssert =
